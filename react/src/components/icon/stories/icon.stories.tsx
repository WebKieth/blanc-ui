...
export const View: Story = {
  render: (args) => (
    <IconifyProvider spriteUrl='https://cdn.jsdelivr.net/npm/remixicon@2.5.0/fonts/remixicon.symbol.svg'>
...
export const RemixIconsExample: Story = {
  render: (args) => {
    return <IconifyProvider spriteUrl='https://cdn.jsdelivr.net/npm/remixicon@2.5.0/fonts/remixicon.symbol.svg'>
